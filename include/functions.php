...
function getMMDVMHostVersion() {
   // returns creation-time or version of MMDVM_Bridge as version-number
...
function getMMDVMHostFileVersion() {
   // returns creation-time of MMDVM_Bridge as version-number
   $filename = MMDVMHOSTPATH."/MMDVM_Bridge";
...
function getGitVersion(){
	if (file_exists(".git")) {
		...
		return 'GitID #<a href="https://github.com/dvswitch/MMDVMHost-Dashboard/commit/'.$output[0].'" target="_blank">'.$output[0].'</a>';
	} else {
